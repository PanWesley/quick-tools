...
- **今日待办**：展示今天和逾期未完成事项，支持标题、日期、时间、归属、提醒偏好、四象限优先级和备注。
- **新增事项**：不再先区分任务和习惯，默认记录一次性事项；选择每天、工作日、周末或每周重复后生成习惯打卡。
- **归属筛选**：新增事项默认归属到生活，也可选择学习、工作、健康、家务、纪念和其他，并在清单页按归属筛选。
- **任务编辑**：任务创建后可继续修改标题、日期、时间、归属、优先级和备注。
...
- 新增事项使用居中弹窗，安排顺序为待定、今天、明天、周末、指定；时间支持全天、时间点和时间段，重复方式决定是否生成习惯。
