...
const CACHE_NAME = 'today-youxu-v5';
const APP_SHELL = [
  '/tools/time/',
  '/tools/time/index.html',
  '/tools/time/manifest.json',
  '/tools/time/css/style.css?v=104',
  '/tools/time/js/date-utils.js?v=104',
  '/tools/time/js/app-state.js?v=104',
  '/tools/time/js/export.js?v=104',
  '/tools/time/js/import-utils.js?v=104',
  '/tools/time/js/db.js?v=104',
  '/tools/time/js/app.js?v=104',
